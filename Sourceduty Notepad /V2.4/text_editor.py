...
class TextEditor:
    def __init__(self, root):
        self.root = root
        self.root.title("Sourceduty Notepad V2.4")
        self.create_menu()
        self.create_widgets()
        self.mode = "Note Mode" 
        self.toggle_mode()
    ...
    def new_file(self):
        ...
        self.root.title("Sourceduty Notepad V2.4 - New File")
        self.update_status()
    ...
    def open_file(self):
        ...
        try:
            ...
            with open(filepath, "r") as input_file:
                ...
                self.update_line_numbers()
            self.root.title(f"Sourceduty Notepad V2.4 - {filepath}")
    ...
    def show_about(self):
        ...
        messagebox.showinfo("About Sourceduty Notepad V2.4", about_text)
