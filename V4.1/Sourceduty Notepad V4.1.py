...
class TextEditor:
    def __init__(self, root):
        self.root = root
        self.root.title("Sourceduty Notepad V4.1")
    ...
    def set_default_description(self):
        default_description = (
            "Sourceduty Notepad V4.1\n"
            "Copyright (C) 2024, Sourceduty\n\n"
            "Welcome to Sourceduty Notepad V4.1, your versatile text editor designed for various industry needs.\n\n"
            "Features:\n"
            ...
            "- File Operations: Open, save, and export files in multiple formats including TXT, DOCX, CSV, PDF, HTML, JSON, and more.\n"
    ...
    def show_options(self):
        messagebox.showinfo("About", "Sourceduty Notepad V4.1\nCopyright (C) 2024, Sourceduty")
